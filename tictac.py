...
def draw_right_angle_line(x, y):
    ...
    turtle.forward(400)
    # 
def draw_maker(player , player_pos):
...
print('-------------------Tic Tac Toe тоглоомонд тавтай морил -------------------')
print('---------------------------------Дүрэм -----------------------------------')
print('**************************************************************************')
print('* Сонгосон тэмдэгтээ 3 дараалуулан байрлуулах:                           *')
print('* 1-ээс 9-ийн хооронд утга гараас оруулах                                *')
print('* Зүүн дээд булан 1-ээс эхлэн Баруун доод булан 9 хүртэл байна.          *')
print('****************************')
print('   Доор нарч ирэх хувилбараас сонголт хийнэ үү')
print('----------------------------')
            ...
            if vs == 1 :
             ...
             if moves_played != 9 :
                ...
                while validate_position(player2_pos)!= True:
                    ...
                    draw_maker(player2 , player2_pos)
                    moves_played += 1
